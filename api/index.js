...
const verifiedHeroHandler=verifiedEbayProductHero.wrap(auditedHandler);
verifiedHeroHandler.EBAY_VERIFIED_PRODUCT_HERO_VERSION=verifiedEbayProductHero.VERSION;
const finalHandler=scoutNavigatorPresentation.wrap(verifiedHeroHandler);
