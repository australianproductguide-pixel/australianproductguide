...
const navigatorHandler=scoutNavigatorPresentation.wrap(auditedHandler);
navigatorHandler.SCOUT_NAVIGATOR_PRESENTATION_VERSION=scoutNavigatorPresentation.VERSION;
navigatorHandler.AUDIT_INTEGRATION_VERSION=auditIntegration.VERSION;
const finalHandler=verifiedEbayProductHero.wrap(navigatorHandler);
