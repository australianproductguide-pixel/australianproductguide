...
// Read-only APG eBay image identity diagnostic v2.7.
...
// supplied by callers. v2.7 switches Paperwhite Signature Edition to a current Brand New 12th-gen 32GB listing.
...
async function handler(req,res){
  ...
  try{
    ...
    const detail=await ebay.getItem(clean(state.item_id),{referenceId:`apg:${slug}:image-diagnostic-v27`,timeoutMs:10000});
