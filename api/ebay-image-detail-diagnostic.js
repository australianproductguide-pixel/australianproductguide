...
// Read-only APG eBay image identity diagnostic v2.8.
...
// supplied by callers. v2.8 switches Paperwhite Signature Edition to Mobileciti's current Metallic Black
// 12th-gen 32GB listing, which publishes the independently verified B0CFPHTMDX model code.
...
async function handler(req,res){
  ...
  try{
    ...
    const detail=await ebay.getItem(clean(state.item_id),{referenceId:`apg:${slug}:image-diagnostic-v28`,timeoutMs:10000});
