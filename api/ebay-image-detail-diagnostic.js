...
// Read-only APG eBay image identity diagnostic v2.3.
...
// supplied by callers. v2.3 switches Kindle (2024) to the current Australian black 16GB listing.
...
const REVIEW_ITEM_ALLOWLIST=Object.freeze({
  ...
  'amazon-kindle-2024':'v1|146971555202|0',
  ...
  'brother-mfc-j4440dw':'v1|255584996655|0',
...
async function handler(req,res){
  ...
  try{
    ...
    const detail=await ebay.getItem(clean(state.item_id),{referenceId:`apg:${slug}:image-diagnostic-v23`,timeoutMs:10000});
