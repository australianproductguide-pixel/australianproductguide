...
const deals=runtime.inject(base,'/deals/');assert.doesNotMatch(deals,/data-ebay-epn-discovery=/);assert.doesNotMatch(deals,/apg-amz-v41-home-grid|apg-amz-v41-art/);assert.doesNotMatch(deals,/data-ebay-official-creatives-v121=/,'Deals remains owned by Smart Placement v1.6');
