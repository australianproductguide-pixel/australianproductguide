...
assert(v505>=0&&v504>=0&&v505<v504&&v504<app,'v50.5 must execute before v50.4 and app.js');
...
console.log(`Decision Lab v50.5 source QA passed above Search v52: v50.4 JSON transport + DOM-only renderer + ${cases.length} supported combinations`);
