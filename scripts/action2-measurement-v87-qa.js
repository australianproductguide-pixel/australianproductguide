...
const direct=layer.enrichScoutPayload({references:['sony-wh-1000xm6'],meta:{amazonAu:{linkType:'affiliate-direct'}},actions:[{label:'View on Amazon Australia',url:'https://www.amazon.com.au/dp/B012345678?tag=auproductguid-22',affiliate:true,external:true}]});
...
const fallback=layer.enrichScoutPayload({references:['sony-wh-1000xm6'],meta:{amazonAu:{linkType:'search-fallback'}},actions:[{label:'Search on Amazon Australia',url:'https://www.amazon.com.au/s?k=Sony+WH-1000XM6&tag=auproductguid-22',affiliate:true,external:true}]});
