...
assert(source.includes('const googleDiscoverabilityPerformanceHandler=googleDiscoverabilityPerformance.wrap(desktopAboutTrustContrastHandler);'),
  'v128 must remain the narrow cache, redirect and viewport-delivery layer');
...
assert(navigatorIndex>=0&&categoryImageIndex>navigatorIndex&&pagespeedIndex>categoryImageIndex&&reviewIndex>pagespeedIndex&&finalPresentationIndex>reviewIndex&&v128Index>finalPresentationIndex&&v132Index>v128Index,
...
console.log(JSON.stringify({
  ...
  laterNonScoringLayers:['reviewProfiles','brandLogoStability','finalPresentationStability-v131','googleDiscoverabilityPerformance-v128','homeResponseHeaderBudget-v132'],
  ...
  intent:'Preserve synchronous transport, accessibility and agentic certification after the completed semantic and image response, retain v126/v127 visuals through a streaming-safe final presentation boundary, and compact only superseded Home diagnostic headers at the final commit boundary.'
},null,2));
