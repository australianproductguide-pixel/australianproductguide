...
const layeredV27=api.includes("require('../lib/evidence-commerce-depth-v27')")&&v27.includes("require('./platform-cohesion-v26')")&&cohesion.includes("require('./account-governance-v25')")&&governance.includes("require('./account-profile-v24')")&&profile.includes("require('./auth-hardening-v23')");
assert(directV23||layeredV23||layeredV25||layeredV26||layeredV27,'api/index.js must preserve auth hardening v23 directly or through the current account/platform wrapper chain');
