...
assert.equal(runtime.FOOTER_NAVIGATION_VERSION,'83.1','footer runtime version');
assert.equal(api.FOOTER_NAVIGATION_VERSION,'83.1','api outer runtime must expose footer v83.1');
...
assert.equal(api.TRUST_CENTRE_VERSION,'82.1','Trust Centre v82.1 must remain underneath footer v83.1');
...
assert.match(injected,/\/assets\/footer-navigation-v83\.css\?v=83\.1/,'footer CSS injection');
assert.match(injected,/\/assets\/footer-navigation-v83\.js\?v=83\.1/,'footer JS injection');
...
assert.match(js,/__APG_FOOTER_NAVIGATION_V83__='83\.1'/,'browser guard must expose v83.1');
...
console.log('FOOTER_NAVIGATION_V83_SOURCE=PASS version=83.1 mobile=2x2 search=52.0 decision=50.6 trust=82.1');
