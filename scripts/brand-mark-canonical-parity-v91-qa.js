...
(async()=>{
  ...
  // retained inside v131. The Home national-card repair is then composed immediately inside
  // Google CSS consolidation, before v132 adds only the final Home response-header budget.
  ...
  const requiredModules=[
    ...
    "require('../lib/home-national-cards-repair-v131-runtime')",
  ...
  assert(api.includes('HOME_NATIONAL_CARDS_REPAIR_VERSION=homeNationalCardsRepair.VERSION'),'Home national-card repair boundary must expose its source version');
