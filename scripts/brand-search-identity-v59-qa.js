...
assert(entry.includes("module.exports=require('../lib/product-brand-placeholder-v64')"),'public entrypoint must use current v64 product brand placeholder presentation layer');
...
console.log('APG Search Brand Identity v59 source QA passed beneath v60, v61, v62, CSP-safe v63 and product brand placeholder v64');
