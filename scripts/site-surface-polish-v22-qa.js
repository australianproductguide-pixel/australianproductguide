...
const viaV27=api.includes("require('../lib/evidence-commerce-depth-v27')")&&v27.includes("require('./platform-cohesion-v26')")&&cohesion.includes("require('./account-governance-v25')")&&governance.includes("require('./account-profile-v24')")&&profile.includes("require('./auth-hardening-v23')")&&auth.includes("require('./site-surface-polish-v22')");
assert(directV22||viaV23||viaV24||viaV25||viaV26||viaV27,'api entry point must preserve the v22 site-surface layer, directly or through the current wrapper chain');
