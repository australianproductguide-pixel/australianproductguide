...
function v4Transform(html,url){
  ...
  if(!out.includes('decision-intelligence-v4.css'))out=out.replace('</head>','<link rel="stylesheet" href="/assets/decision-intelligence-v4.css?v=4"></head>');
