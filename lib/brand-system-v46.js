...
const RESEARCH_PROOF_VERSION='46.1';
...
function inject(html){
  ...
  // must remain last so the exception overrides the general v46 navy proof-band rule.
...
Object.assign(handler,{VERSION,CSS_PATH,COMMERCE_CSS_PATH,IMAGERY_CSS_PATH,RESEARCH_PROOF_CSS_PATH,RESEARCH_PROOF_VERSION,MARKER,inject,downstream});
