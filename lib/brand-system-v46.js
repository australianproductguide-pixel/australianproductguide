...
const FINAL_CSS_VERSION='46.5';
const NAV_PARITY_CSS_PATH='/assets/desktop-nav-parity-v50.css';
const NAV_PARITY_CSS_VERSION='50';
...
function inject(html){
  ...
  if(!out.includes(`${NAV_PARITY_CSS_PATH}?v=${NAV_PARITY_CSS_VERSION}`))links.push(`<link rel="stylesheet" href="${NAV_PARITY_CSS_PATH}?v=${NAV_PARITY_CSS_VERSION}">`);
...
Object.assign(handler,{VERSION,CSS_PATH,COMMERCE_CSS_PATH,IMAGERY_CSS_PATH,FINAL_CSS_PATH,FINAL_CSS_VERSION,NAV_PARITY_CSS_PATH,NAV_PARITY_CSS_VERSION,RESEARCH_PROOF_CSS_PATH,RESEARCH_PROOF_VERSION,MARKER,inject,downstream});
