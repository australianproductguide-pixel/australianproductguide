...
function inject(html){
  ...
  // Final standard-UI cleanup: old teal/gold campaign surfaces are not current APG UI.
  ...
  // must remain last within v46 so the exception overrides general v46 presentation rules.
