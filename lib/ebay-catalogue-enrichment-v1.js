...
// APG eBay catalogue enrichment v1.7
...
// v1.7 adds a deliberately tiny parent/sub-brand equivalence register for exact-product image
// verification where eBay structured brand metadata uses the parent brand. All model, family,
// variant, category, condition, price and independent second-pass controls remain unchanged.
...
const BRAND_EQUIVALENCE_GROUPS=Object.freeze([
  ...
  Object.freeze(['philips','philips hue'])
]);
