...
// APG eBay catalogue enrichment v1.6
...
// v1.6 keeps accessory detection on listing titles/categories rather than concatenated item-specific
// metadata, where labels such as Manufacturer Part Number or Included Accessories created false
// positives. It also recognises repeated-V universal voltage ranges and treats X as a material model
// suffix so products such as Shure MV7+ cannot be confused with the XLR-only MV7X.
...
module.exports={
  VERSION,AUTO_ACCEPT_SCORE,REVIEW_SCORE,MAX_CANDIDATES,MAX_DETAIL_CHECKS,UNINFORMATIVE_IDENTITY_VALUES,
