...
// APG eBay catalogue enrichment v1.10
...
// v1.9 strips Unicode combining marks after NFKD normalisation so equivalent brand/model spellings
// such as Kärcher/Karcher reconcile correctly. All exact-product, variant, category, condition,
// price and independent second-pass controls remain unchanged.
// v1.10 treats eBay's explicit "Not supplied" identity placeholder as uninformative so exact title-model
// evidence can proceed through the existing guards; genuine conflicting structured identity still fails closed.
...
module.exports={
  ...
  norm,compact,tokens,informativeIdentityEvidence,specModelValues,productModelSource,productIdentitySource,isUnitLikeModel,isFeatureDescriptorModel,
