...
// APG eBay catalogue enrichment v1.13
...
// v1.13 treats eBay's literal structured Brand value "Branded" as uninformative placeholder metadata,
// just like Generic/Unbranded. A listing must still carry the maintained APG brand in its title and
// pass all model, category, accessory, variant, condition, voltage, price and media gates.
// v1.12 added Item Model Number / Model Number structured model evidence.
...
const UNINFORMATIVE_IDENTITY_VALUES=new Set([
  ...
  'no brand','brandless','unbranded','generic','branded','universal','no model','see description','as pictured'
]);
