...
const headerMarketplace=require('./header-marketplace-v1223-runtime');
...
function wrap(downstream){
  ...
  // Header Marketplace v122.3 remains inside Navigator so APG's established certification
  // invariant is preserved: Navigator is still the final Scout visual-cascade wrapper on every
  // route. v122.3 only condenses the mobile masthead; it cannot score, rank or persist state.
  ...
  Object.assign(handler,smartDownstream,{
    ...
    HEADER_MARKETPLACE_MOBILE_CONDENSED_VERSION:headerMarketplace.VERSION
  });
  return handler;
}
