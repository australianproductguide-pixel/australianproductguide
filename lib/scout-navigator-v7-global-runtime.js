...
function wrap(downstream){
  ...
  Object.assign(handler,smartDownstream,{SCOUT_NAVIGATOR_PRESENTATION_VERSION:VERSION,SCOUT_NAVIGATOR_CSS_PATH:CSS_PATH,scoutNavigatorCss:css,injectScoutNavigatorPresentation:inject,EBAY_SMART_PLACEMENT_VERSION:ebaySmartPlacement.VERSION,HEADER_NAVIGATION_VERSION:headerNavigation.VERSION});
  return handler;
}
