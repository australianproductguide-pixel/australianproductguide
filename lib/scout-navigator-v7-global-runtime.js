...
function wrap(downstream){
  ...
  // The Smart Placement pilot sits immediately inside Navigator's final presentation wrapper.
  // This keeps Navigator as the last CSS cascade while allowing Smart Placement to intercept the
  // /deals/ CSP before the underlying runtime emits headers. It remains retailer presentation only.
  ...
  Object.assign(handler,smartDownstream,{SCOUT_NAVIGATOR_PRESENTATION_VERSION:VERSION,SCOUT_NAVIGATOR_CSS_PATH:CSS_PATH,scoutNavigatorCss:css,injectScoutNavigatorPresentation:inject,EBAY_SMART_PLACEMENT_VERSION:ebaySmartPlacement.VERSION});
  return handler;
}
