...
const headerMarketplace=require('./header-marketplace-v1221-runtime');
...
function wrap(downstream){
  ...
  // Header marketplace cleanup v122.1 remains inside Navigator so APG's established certification invariant is preserved:
  ...
  Object.assign(handler,smartDownstream,{SCOUT_NAVIGATOR_PRESENTATION_VERSION:VERSION,SCOUT_NAVIGATOR_CSS_PATH:CSS_PATH,scoutNavigatorCss:css,injectScoutNavigatorPresentation:inject,EBAY_SMART_PLACEMENT_VERSION:ebaySmartPlacement.VERSION,HEADER_NAVIGATION_VERSION:headerMarketplace.HEADER_NAVIGATION_VERSION,HEADER_MARKETPLACE_VERSION:headerMarketplace.HEADER_MARKETPLACE_VERSION,HEADER_MARKETPLACE_CLEANUP_VERSION:headerMarketplace.VERSION});
  return handler;
}
