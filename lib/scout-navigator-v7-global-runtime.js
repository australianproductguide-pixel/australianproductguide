...
function wrap(downstream){
  ...
  Object.assign(handler,downstream,{SCOUT_NAVIGATOR_PRESENTATION_VERSION:VERSION,SCOUT_NAVIGATOR_CSS_PATH:CSS_PATH,scoutNavigatorCss:css,injectScoutNavigatorPresentation:inject});
  return handler;
}
