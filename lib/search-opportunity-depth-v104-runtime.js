...
// its existing authoritative source and regression controls. Decision hard-constraint
// correctness v103.6 remains the immediate downstream runtime so v104 cannot bypass it.
const downstream=require('./decision-hard-constraint-fallback-v1036');
