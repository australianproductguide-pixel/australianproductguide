...
// APG About & Trust Navigation v116.2.
...
function mobileSocial(){
  return `<div class="apg-mobile-social-v56" aria-label="Follow Australian Product Guide"><div class="apg-mobile-social-v56-list"><a class="apg-mobile-social-v56-link" href="https://www.instagram.com/australianproductguide" target="_blank" rel="noopener noreferrer"><span>Instagram</span><span aria-hidden="true">↗</span></a><a class="apg-mobile-social-v56-link" href="https://www.pinterest.com/australianproductguide/" target="_blank" rel="noopener noreferrer"><span>Pinterest</span><span aria-hidden="true">↗</span></a></div></div>`;
}
function mobileNavigationContent(searchForm=''){
  return `${searchForm}${mobileSection('Shop & decide',[
    ...
    ['Contact us','/contact/']
  ])}${mobileSocial()}${mobileSection('Your APG',[
...
.apg-mobile-v8 .apg-mobile-social-v56{padding:8px 0 0}
.apg-mobile-v8 .apg-mobile-social-v56-list{display:grid;grid-template-columns:minmax(0,1fr);gap:6px}
.apg-mobile-v8 .apg-mobile-social-v56-link{min-height:44px;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 12px;border:1px solid #e2e8f0;border-radius:10px;background:#fff;color:#0f2f4a;font-size:12px;font-weight:800;line-height:1.2;text-decoration:none}
.apg-mobile-v8 .apg-mobile-social-v56-link:hover,.apg-mobile-v8 .apg-mobile-social-v56-link:focus-visible{background:#eff6ff;color:#1d4ed8;border-color:#bfdbfe}
.apg-mobile-v8 .apg-mobile-social-v56-link:focus-visible{outline:2px solid #2563eb;outline-offset:1px}
...
module.exports={VERSION,CSS_PATH,JS_PATH,desktopAboutTrust,mobileNavigationContent,mobileSocial,stripProductTrust,enhanceDesktop,enhanceMobile,injectAssets,transformHtml,css,clientJs,wrap,install};
