...
// APG About & Trust Navigation v116.5.
...
// v116.5 keeps the mobile Scout launcher behaviour while normalising its typography and
// colour across rest, hover, focus and active states to match the standard navigation rows.
...
function stripProductTrust(html){
  ...
  // Only remove a section whose own first heading is Trust & transparency. Do not span
  // preceding product/research sections while looking for that heading.
...
.apg-mobile-v8 .mobile-section .apg-mobile-nav-action{-webkit-appearance:none!important;appearance:none!important;display:flex;width:100%;align-items:center;justify-content:space-between;gap:12px;min-height:44px;padding:10px 12px;border:0;border-radius:9px;background:transparent!important;color:#0f172a!important;-webkit-text-fill-color:#0f172a!important;font:inherit;font-weight:650;text-align:left;opacity:1!important;cursor:pointer}
.apg-mobile-v8 .mobile-section .apg-mobile-nav-action span{color:#0f172a!important;-webkit-text-fill-color:#0f172a!important;opacity:1!important}
.apg-mobile-v8 .mobile-section .apg-mobile-nav-action:hover,.apg-mobile-v8 .mobile-section .apg-mobile-nav-action:focus-visible,.apg-mobile-v8 .mobile-section .apg-mobile-nav-action:active{background:#eff6ff!important;color:#1d4ed8!important;-webkit-text-fill-color:#1d4ed8!important}
.apg-mobile-v8 .mobile-section .apg-mobile-nav-action:hover span,.apg-mobile-v8 .mobile-section .apg-mobile-nav-action:focus-visible span,.apg-mobile-v8 .mobile-section .apg-mobile-nav-action:active span{color:#1d4ed8!important;-webkit-text-fill-color:#1d4ed8!important}
...
.apg-mobile-v8 [data-apg-about-trust-mobile] .mobile-section button.apg-mobile-nav-action[data-apg-system-scout],.apg-mobile-v8 [data-apg-about-trust-mobile] .mobile-section button.apg-mobile-nav-action[data-apg-system-scout]:hover,.apg-mobile-v8 [data-apg-about-trust-mobile] .mobile-section button.apg-mobile-nav-action[data-apg-system-scout]:focus-visible,.apg-mobile-v8 [data-apg-about-trust-mobile] .mobile-section button.apg-mobile-nav-action[data-apg-system-scout]:active{color:#0f172a!important;-webkit-text-fill-color:#0f172a!important;font-family:inherit!important;font-size:inherit!important;font-style:normal!important;font-weight:650!important;line-height:inherit!important;letter-spacing:normal!important;text-transform:none!important}
