...
// APG About & Trust Navigation v116.9.
...
// v116.9 preserves the white desktop About & trust trigger while explicitly isolating
// light-popover link colours from primary-nav colour and text-fill overrides.
...
/* APG About & Trust Navigation v116.9 */
.apg-about-trust-menu{position:relative;margin-left:auto;min-width:0;color:#fff}
...
.apg-about-trust-popover .apg-about-trust-column a:not(.apg-about-trust-contact-link),.apg-about-trust-popover .apg-about-trust-column a:not(.apg-about-trust-contact-link):visited{color:#1e3a52!important;-webkit-text-fill-color:#1e3a52!important}
.apg-about-trust-popover .apg-about-trust-column a>span{color:inherit!important;-webkit-text-fill-color:currentColor!important}
.apg-about-trust-column a:hover,.apg-about-trust-column a:focus-visible{background:#eff6ff;color:#1d4ed8!important;-webkit-text-fill-color:#1d4ed8!important}
.apg-about-trust-column a:focus-visible{outline:2px solid #2563eb;outline-offset:1px}
.apg-about-trust-contact-link{margin-top:3px;border:1px solid #bfdbfe;background:#eff6ff;color:#1d4ed8!important;-webkit-text-fill-color:#1d4ed8!important}
...
.apg-mobile-v8 .mobile-section .apg-mobile-nav-action{-webkit-appearance:none!important;appearance:none!important;display:flex;width:100%;align-items:center;justify-content:space-between;gap:12px;min-height:44px;padding:8px 14px!important;margin:0!important;border:0;border-radius:8px;background:transparent!important;color:#0f172a!important;-webkit-text-fill-color:#0f172a!important;font-family:inherit!important;font-size:16px!important;font-style:normal!important;font-weight:650!important;line-height:inherit!important;letter-spacing:normal!important;text-transform:none!important;text-align:left;opacity:1!important;cursor:pointer;box-sizing:border-box}
...
.apg-mobile-v8 [data-apg-about-trust-mobile] .mobile-section button.apg-mobile-nav-action[data-apg-system-scout]{padding:8px 14px!important;margin:0!important;border-radius:8px!important;color:#0f172a!important;-webkit-text-fill-color:#0f172a!important;font-family:inherit!important;font-size:16px!important;font-style:normal!important;font-weight:650!important;line-height:inherit!important;letter-spacing:normal!important;text-transform:none!important}
