...
// APG About & Trust Navigation v116.3.
...
function mobileSocial(){
  ...
  return `<div class="apg-mobile-social-v56" aria-label="Follow Australian Product Guide"><div class="apg-mobile-social-v56-list">${profiles.map(([label,href,key])=>`<a class="apg-mobile-social-v56-link is-${key}" href="${esc(href)}" target="_blank" rel="me noopener noreferrer"><span>${esc(label)}</span><span aria-hidden="true">↗</span></a>`).join('')}</div></div>`;
}
...
.apg-mobile-v8 .apg-mobile-social-v56-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}
.apg-mobile-v8 .apg-mobile-social-v56-link{min-height:44px;display:flex;align-items:center;justify-content:space-between;gap:8px;padding:10px 12px;border:1px solid #e2e8f0;border-radius:10px;background:#fff;color:#0f2f4a;font-size:12px;font-weight:800;line-height:1.2;text-decoration:none}
...
@media(max-width:380px){.apg-mobile-v8 .apg-mobile-social-v56-list{grid-template-columns:minmax(0,1fr)}}
