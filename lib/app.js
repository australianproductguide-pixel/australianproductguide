...
module.exports=(req,res)=>{
  ...
  if(path==='/assets/site.css')return send(req,res,200,'text/css; charset=utf-8',css+decisionCss,{'Cache-Control':'public, max-age=3600'});
  if(path==='/assets/app.js')return send(req,res,200,'application/javascript; charset=utf-8',clientJs+decisionClientJs,{'Cache-Control':'public, max-age=3600'});
  ...
  if(html)return send(req,res,200,'text/html; charset=utf-8',enhanceDecisionShell(html));
  return send(req,res,404,'text/html; charset=utf-8',enhanceDecisionShell(pages.notFound(req)),{'X-Robots-Tag':'noindex,follow'});
};
