...
function renderV7(html,path,u){return enhanceFooterV8(enhancePlatformV7(enhancePlatformV5(enhancePlatformV3(enhanceDecisionShell(html),path,u),path,u),path,u));}
module.exports=(req,res)=>{
  ...
  if(path==='/assets/site.css')return send(req,res,200,'text/css; charset=utf-8',css+decisionCss+platformV3Css+platformV5Css+platformV6Css+platformV7Css+platformV7RichCss+footerV8Css,{'Cache-Control':'public, max-age=3600'});
