...
function renderV7(html,path,u){
  ...
  return enhanceFooterV8(shopping.enhance(platform,path,u));
}
module.exports=(req,res)=>{
  ...
  if(path==='/assets/site.css')return send(req,res,200,'text/css; charset=utf-8',css+decisionCss+platformV3Css+platformV5Css+platformV6Css+platformV7Css+platformV7RichCss+footerV8Css+shopping.css,{'Cache-Control':'public, max-age=3600'});
