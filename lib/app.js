...
module.exports=(req,res)=>{
  ...
  if(path==='/assets/app.js')return send(req,res,200,'application/javascript; charset=utf-8',clientJs+decisionClientJs+platformV3ClientJs+accountSyncClientJs,{'Cache-Control':'public, max-age=3600'});
  ...
  if(html){html=enhanceAccountPolicy(html,path);return send(req,res,200,'text/html; charset=utf-8',enhancePlatformV3(enhanceDecisionShell(html),path,u));}
