...
module.exports=(req,res)=>{
  ...
  if(path==='/api/catalogue.csv'){
    if(readOnly(req,res))return;
    return send(req,res,200,'text/csv; charset=utf-8',catalogueCsv(),{'Cache-Control':'public, max-age=3600','X-Robots-Tag':'noindex','Content-Disposition':'inline; filename="apg-platform-v5-catalogue.csv"'});
  }
  ...
  if(path==='/assets/site.css')return send(req,res,200,'text/css; charset=utf-8',css+decisionCss+platformV3Css+platformV5Css,{'Cache-Control':'public, max-age=3600'});
