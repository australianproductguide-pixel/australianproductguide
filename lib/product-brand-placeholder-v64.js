...
const PRODUCT_BRAND_PLACEHOLDER_VERSION='64.1';
const STYLESHEET='/assets/product-brand-placeholder-v64.css?v=64.1';
...
function enrichProductBrandPlaceholders(html){
  ...
  // Keep the temporary brand-led visual consumer-facing. The underlying image-rights
  // and photography status remains disclosed in APG evidence/provenance surfaces; the
  // visual itself should help the shopper understand what they can do next.
  out=out.replace(/APG visual · genuine product photography pending verified rights/g,'Product profile · features, trade-offs and buying fit');
  out=out.replace(/Australian Product Guide visual · genuine product photography pending verified rights/g,'Product profile · features, trade-offs and buying fit');
  out=out.replace(/Brand identity placeholder · genuine product photography pending verified rights/g,'Product profile · features, trade-offs and buying fit');
  out=out.replace(/Australian Product Guide-authored SVG\/CSS decision visual/g,'Brand identity placeholder via APG governed brand resolver');
  return out;
}
