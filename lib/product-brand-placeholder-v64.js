...
function enrichProductBrandPlaceholders(html){
  ...
  // illustration note/provenance is present. This is not a claim that the logo depicts
  // the product; the photography status remains pending until an authorised exact image exists.
