...
const MOBILE_HEADER_WORDMARK_VERSION='75.0';
...
function inject(html){
  ...
  return out.replace(
    '</head>',
    `<meta name="apg-mobile-header-wordmark" content="v${MOBILE_HEADER_WORDMARK_VERSION}"><link rel="stylesheet" href="${CSS_PATH}?v=${MOBILE_HEADER_WORDMARK_VERSION}"></head>`
  );
}
...
function handler(req,res){
  ...
  res.setHeader('X-APG-Mobile-Header-Wordmark','v'+MOBILE_HEADER_WORDMARK_VERSION);
...
Object.assign(handler,downstream,{MOBILE_HEADER_WORDMARK_VERSION,CSS_PATH,css,inject});
