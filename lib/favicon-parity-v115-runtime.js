...
// It also carries the owner-authorised Commission Factory website verification meta tag.
...
function inject(html){
  ...
  return out.replace(/<\/head>/i,`${marker}${COMMISSION_FACTORY_VERIFICATION}${ICON_LINKS}</head>`);
}
...
module.exports={VERSION,META_NAME,COMMISSION_FACTORY_VERIFICATION,ICON_LINKS,stripManagedIconLinks,inject,wrap,install};
