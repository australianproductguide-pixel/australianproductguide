...
function snapshot(){
  ...
  const entityCorrections=[...enrichmentPass2.unresolvedEntityCorrections,...enrichmentPass3.unresolvedEntityCorrections];
  return{
...
Object.assign(handler,{VERSION,API_PATH,PRODUCT_API_PREFIX,BENCHMARK,enrichment,enrichmentPass2,enrichmentPass3,depthFor,categoryDepth,snapshot,downstream});
