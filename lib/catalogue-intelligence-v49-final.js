...
function snapshot(){
  ...
  return{
    ...
    evidenceDepth:{strongDepthVerified:strong,belowStrongDepth:products.length-strong,strongDepthCoveragePct:Math.round(strong/products.length*1000)/10,exactPrimaryEvidenceEstablished:primary,independentlyResearchedInV49:researched,primarySourceRecordsStructuredInPass1:structuredThisPass},
    enrichment:{
...
Object.assign(handler,{VERSION,API_PATH,PRODUCT_API_PREFIX,BENCHMARK,enrichment,enrichmentPass2,enrichmentPass3,enrichmentPass4,depthFor,categoryDepth,snapshot,downstream});
