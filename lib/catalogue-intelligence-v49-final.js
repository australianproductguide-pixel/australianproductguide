...
function snapshot(){
  ...
  return{
    ...
    researchBacklog:{needsStrongDepthVerification:products.length-strong,needsEntityCorrection:enrichmentPass2.unresolvedEntityCorrections.length,policy:'This is the remaining source-by-source evidence programme. Products are not upgraded to strong-depth merely because they are maintained, commercially available or classification-relevant. Identity conflicts and discontinued products are corrected rather than papered over.'},
...
Object.assign(handler,{VERSION,API_PATH,PRODUCT_API_PREFIX,BENCHMARK,enrichment,enrichmentPass2,depthFor,categoryDepth,snapshot,downstream});
