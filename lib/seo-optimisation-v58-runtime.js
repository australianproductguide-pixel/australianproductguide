...
// Final-response SEO layer. It sits outside Social Share Card v57 so the
// owner-approved APG campaign image remains the default social preview, while
// relevant category imagery or exact verified product imagery can override it.
// It does not change recommendation scoring, retailer ordering or affiliate logic.
const downstream=require('./social-share-card-v57-runtime');
