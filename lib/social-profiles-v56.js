...
const socialProfiles=Object.freeze({
  facebook:Object.freeze({platform:'Facebook',displayName:'Australian Product Guide',handle:null,url:null,active:true,verified:false,status:'active-public-url-pending',purpose:'Consumer social presence, video and community distribution'}),
