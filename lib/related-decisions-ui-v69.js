...
// Related Buying Decisions UI sits above the governed brand-identity completion layers.
// Deep Official v70 is the current outer brand-mark layer so Brands, product placeholders
// and every responsive surface receive the same current identity decision.
const downstream=require('./brand-mark-deep-official-v70');
