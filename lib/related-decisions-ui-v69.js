...
// Related Buying Decisions UI sits above the governed brand-identity completion layer.
// Keeping the official-completion resolver in the live downstream chain ensures Brands,
// product placeholders and every responsive surface receive the same v69.1 policy and
// official-logo decisions even when later presentation layers wrap this module.
const downstream=require('./brand-mark-official-completion-v69');
const {categories}=require('../data');
const {categoryCard}=require('./ui');

// Keep the established v69 marker expected by SEO QA; the brand layer underneath carries
// its own independent X-APG/meta version (v69.1).
