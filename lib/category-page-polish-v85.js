...
const CATEGORY_PAGE_POLISH_VERSION='85.0';
const CSS_PATH='/assets/category-page-polish-v85.css';
...
/* Keep the two primary category actions visually distinct from the priority pills. */
...
/* What Matters: retain the compact numbered badge, but use APG blue rather than legacy green/gold. */
