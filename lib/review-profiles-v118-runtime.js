...
// APG Review Profiles v118.0.
// Presentation-only trust layer. Makes APG's external consumer-review profiles easy to
// inspect from both the global About & trust navigation and the footer. These destinations
// do not influence product eligibility, recommendation scoring, retailer ranking or evidence.
const VERSION='118.0';
...
module.exports={VERSION,TRUSTPILOT_URL,PRODUCTREVIEW_URL,externalTrustLink,footerLink,addDesktopReviewProfiles,addMobileReviewProfiles,addFooterReviewProfiles,transformHtml,wrap};
