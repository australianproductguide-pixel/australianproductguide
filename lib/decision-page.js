...
function decisionLab(req,u){
  ...
  return layout(req,{title:'APG Decision Lab | Explainable Product Matching',description:'Describe what you need and get an explainable shortlist from Australian Product Guide’s maintained product data.',path,body,noindex:true,crumbs:[homeCrumb,{name:'Decision Lab',path}],bodyData:`data-decision-query="${esc(q)}" data-decision-url="${esc(persistedUrl)}"`});
}
