...
// My APG v123 uses the server-mediated account platform as the single authentication and
// login/signup mode owner. The older direct-browser Supabase panel must not initialise there.
if(location.pathname==='/my-apg/'&&document.body&&document.body.dataset.apgMyApgAccountJourney)return;
