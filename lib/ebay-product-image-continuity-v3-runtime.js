...
// APG eBay product-image continuity v3.5.
...
// v3.5 adds a non-sensitive response diagnostic on product routes so fail-closed render misses can
// be distinguished from successful governed-image insertion without exposing retailer evidence.
