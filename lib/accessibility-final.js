...
/* Action 1 Production accessibility control: retain a safe >4.5:1 neutral on light surfaces.
   Explicit opacity prevents later presentation layers from blending these small labels back
   below WCAG AA contrast. */
.crumbs span[aria-current="page"],
.share-context,
.large>.visual-copy>small,
.fact-card>dt,
...
.workspace-empty{color:#455a63!important;opacity:1!important}
...
module.exports=(req,res)=>{
  ...
  res.end=(body,...args)=>{
    ...
    if(req.method!=='HEAD'&&typeof body==='string'&&path==='/assets/site-optimised.css')body+=EXTRA_CSS;
