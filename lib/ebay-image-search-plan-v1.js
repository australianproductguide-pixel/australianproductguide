...
// APG eBay image search plan v1.12
...
// v1.12 adds the exact current eBay AU listing identity for Withings Body Comp to retrieval.
// Identifiers improve retrieval only; they never bypass guards.
...
// Verified from current public eBay Australia product entities on 4-6 Sep 2026.
...
const VERIFIED_EBAY_EPIDS=Object.freeze({
  ...
  'samsung-galaxy-smarttag2':'10067218835',
  'apple-airtag-4-pack':'12045899841',
  'fujifilm-instax-link-wide':'27051109403',
  'nintendo-switch-pro-controller':'7048832556',
  'asus-tuf-gaming-vg27aql3a':'11067836134',
  'insta360-x4':'27066712740',
  'blue-yeti-usb-microphone':'19038155298',
  'microsoft-xbox-wireless-controller':'27087046361',
  'bose-smart-soundbar':'10072315702',
  'crucial-x9-pro-portable-ssd-1tb':'12064364761',
  'eufy-baby-monitor-e210-spaceview-pro':'11064909550',
  'dyson-purifier-cool-pc1':'10084275170',
  'philips-sonicare-3100-series':'26050729381',
  'anker-prime-100w-gan-wall-charger':'3062598572',
  'ugreen-revodok-pro-106-usb-c-hub':'10065663263',
  'tile-mate':'15073591491'
});

// Exact product identifiers independently verified from Australian manufacturer, official-brand
// marketplace or reputable Australian retailer evidence on 4-6 Sep 2026. They are retrieval aliases
...
const VERIFIED_SEARCH_ALIASES=Object.freeze({
  ...
  'samsung-galaxy-smarttag2':['EI-T5600BBEGAU','8806095378282'],
  'apple-airtag-4-pack':['MX542ZP/A','0190199320345'],
  'fujifilm-instax-link-wide':['86563','4547410455632'],
  'nintendo-switch-pro-controller':['HAC013'],
  'asus-tuf-gaming-vg27aql3a':['0197105154858'],
  'insta360-x4':['INSTAONEX4','6970357855506'],
  'blue-yeti-usb-microphone':['988000402','0836213001653'],
  'microsoft-xbox-wireless-controller':['EP229931','0196388518173'],
  'bose-smart-soundbar':['8920791100','0017817856188'],
  'crucial-x9-pro-portable-ssd-1tb':['CT1000X9PROSSD9','0649528938367'],
  'eufy-baby-monitor-e210-spaceview-pro':['0194644149543'],
  'dyson-purifier-cool-pc1':['5025155099902'],
  'philips-sonicare-3100-series':['HX3671/14','8710103985587'],
  'anker-prime-100w-gan-wall-charger':['A2343','0194644136147'],
  'ugreen-revodok-pro-106-usb-c-hub':['0744759130594'],
  'tile-mate':['RE-60021-AP','0819039025034'],
  'tile-pro':['RE-43001','0819039022668'],
  'tp-link-tapo-p110':['TAPO-P110','4897098681978'],
  'withings-body-comp':['WBS12-BLACK','287344476885'],
  'karcher-k5-premium-smart-control':['1.324-673.0','4054278786537'],
  'ugreen-revodok-1071-usb-c-hub':['15214'],
  'marshall-monitor-iii-anc':['1006861','7340055401777'],
  'zerowater-12-cup-ready-pour-water-filter-jug':['ZD-012RP','851510006019']
});
