...
// APG eBay image search plan v1.5
...
// v1.5 extends the small evidence-backed identifier layer for difficult residual products. ePIDs
// and manufacturer product codes improve retrieval only; they never bypass candidate, detail,
// exact-guard or independent second-pass verification.
...
// Exact product identifiers independently verified from manufacturer or reputable catalogue
// evidence on 4 Sep 2026. They are retrieval aliases only and therefore do not alter APG's
// maintained product identity or bypass any exact-product acceptance guard.
const VERIFIED_SEARCH_ALIASES=Object.freeze({
  ...
  'anker-547-usb-c-hub-7-in-2':['A8354']
});
