...
function trustReadiness(){
  ...
  const creatorsApiCredentialsConfigured=Boolean(process.env.AMAZON_CREATORS_CLIENT_ID&&process.env.AMAZON_CREATORS_CLIENT_SECRET);
  return {
    version:VERSION,
    checkedAt:CHECKED,
    passwordPolicy:{
    ...
    retailers:{
      ...
      manufacturerDirectOfferCount:retailers.manufacturerDirectOfferCount||0,
      independentOrDirectOfferCount:retailers.independentOrDirectOfferCount||retailers.independentRetailerOfferCount,
      verifiedRetailerOrManufacturerSources:retailers.verifiedRetailers,
