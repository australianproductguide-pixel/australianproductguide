...
function snapshot(){
  ...
  return {
    ...
    releaseGate:{pass:Object.values(releaseChecks).every(Boolean),checks:releaseChecks,decisionIntelligence:q.releaseGate,requirements:['Decision Intelligence quality gate passes','Scout benchmark scenarios pass','No invalid verified image records','At least 15 verified exact Australian retailer/manufacturer offer destinations','Affiliate recommendation weight remains zero']}
  };
}
