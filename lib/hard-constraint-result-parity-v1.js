...
function intentFor(q='',opts={},fallback=null){
  ...
  else if(opts&&opts.decisionState&&typeof opts.decisionState==='object'&&typeof engine.intentFromDecisionState==='function')intent=engine.intentFromDecisionState(opts.decisionState,opts);
