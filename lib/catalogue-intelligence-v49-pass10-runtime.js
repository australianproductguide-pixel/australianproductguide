...
function snapshot(){
  ...
  return{
    ...base,
    enrichment:{...base.enrichment,pass10:{version:enrichmentPass10.version,verifiedAt:enrichmentPass10.verifiedAt,newPrimaryResearch:enrichmentPass10.newPrimaryResearch,missing:enrichmentPass10.missing,unresolvedEntityCorrections:enrichmentPass10.unresolvedEntityCorrections,canonicalAliases:Object.keys(canonical.aliases).length}},
...
Object.assign(handler,downstream,{snapshot,enrichmentPass10,canonical,downstream});
