...
// APG Social + Footer Polish v93.0
//
// Presentation-only refinement of APG's shared social profile surfaces and mobile
// footer. It addresses two observed mobile defects:
//   1) the final row of social cards visually collided with the footer rule; and
//   2) the Cookie preferences control was not aligned to the footer content edge.
//
// It also standardises the social identity treatment across footer, mobile navigation
// and other shared v56 social surfaces. Platform marks remain unembellished and equal
// in visual weight. Threads is updated to the current 2026 app mark published by Meta
// (mirrored by Wikimedia Commons from the official source); the existing Facebook,
// Instagram, X, Pinterest and LinkedIn canonical glyph forms are retained and presented
// in their standard brand treatments. No social destination, recommendation logic,
// analytics, SEO, commerce behaviour or consent semantics are changed.
const downstream=require('./category-directory-mobile-alignment-v92');

const VERSION='93.0';
const CSS_PATH='/assets/social-footer-polish-v93.css';
const ORIGIN='https://australianproductguide.au';
const THREADS_2026_ASSET='https://upload.wikimedia.org/wikipedia/commons/c/cb/Threads_2026_app_icon.svg';
...
const marks=Object.freeze({
  ...
  threads:`<img src="${THREADS_2026_ASSET}" alt="" width="28" height="28" loading="lazy" decoding="async">`,
...
@media (max-width:700px){
  ...
  .apg-cookie-footer-wrap{
    ...
    width:100%!important;
    margin:0!important;
    padding:20px 36px calc(24px + env(safe-area-inset-bottom,0px))!important;
  }
...
Object.assign(handler,downstream,{
  ...
  SOCIAL_FOOTER_POLISH_THREADS_ASSET:THREADS_2026_ASSET,
