...
// APG eBay product-image exact identity guard v3.28.
// Extends v3.27 with one exact item-bound Microsoft Xbox Wireless Controller Carbon Black recovery
// from eBay's mixed "Controllers & Attachments" category. The exception requires item 278181980555,
// exact Xbox Wireless Controller / Carbon Black title identity and structured EP2-29931 model evidence;
// it does not broaden gaming-controller category or Microsoft/Xbox brand acceptance generally.
// All prior accessory, sibling, bundle, category, condition, price, model/variant, active-listing and
// AU marketplace controls remain fail-closed.
...
function verifiedDirectNamedIdentity(product,accepted,hostCompatibility){
  ...
  // searchKind is a retrieval-time hint and is deliberately not persisted. Exact item identity plus
  // an independently reproducible whole-product rule is the durable proof required here.
