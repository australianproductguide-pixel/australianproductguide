...
// APG eBay product-image exact identity guard v3.21.
// Extends v3.20 with one item-bound PETLIBRO Air Smart Feeder recovery. The current eBay AU item is
// Brand New and its live title/specification set says PETLIBRO, 2L, wire-free Air automatic Wi-Fi
// feeder; PETLIBRO Australia independently identifies the Air Smart Feeder as the 2L PLAF108 model
// with matching cordless/app-control characteristics and dimensions. The rule is bound to one exact
// item and does not relax generic named-product matching. Revodok Pro 106, ZeroWater, Revodok 1071,
// Insta360 X4/X5, Paperwhite and prior rules are unchanged. Generic accessory, sibling, bundle,
// category, condition, voltage, AUD-price, eBay-image-host, eBay AU URL and active-listing controls
// remain fail-closed, including the v3.13 mount protection.
