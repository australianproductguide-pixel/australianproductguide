...
// APG eBay product-image exact identity guard v3.7.
// Extends v3.6 by normalising the category leaf only for evidence-bound exact eBay item IDs whose
// detailed product evidence is correct but whose marketplace taxonomy places the whole product in an
// accessory-like leaf. The canonical leaf is applied only after exact slug + current Browse item ID
// + product-title identity checks. Unregistered items remain fail-closed and all model, sibling,
// bundle, voltage, condition, AUD-price, URL, active-listing and independent second-pass controls
// still run. Recommendation weight remains zero.
...
const EVIDENCE_BOUND_CANONICAL_LEAVES=Object.freeze({
  ...
  'dash-cameras':'Dash Cams',
  'smart-displays':'Smart Displays',
  'portable-fridges':'Portable Fridges',
  'televisions':'Televisions',
  'smart-scales':'Bathroom Scales',
  'bluetooth-trackers':'Smart Trackers'
});
