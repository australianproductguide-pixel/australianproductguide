...
// APG eBay product-image exact identity guard v3.11.
// Extends v3.10 with an item-bound recovery rule for the Dyson Purifier Cool PC1 544929-01.
// eBay currently classifies that exact whole appliance under a fan-parts leaf. APG only overrides
// that metadata for the verified item ID when the title repeats Dyson, Purifier Cool PC1 and
// 544929-01. The same item must still pass brand, condition, voltage, sibling/variant, AUD-price,
// eBay-hosted image, eBay AU item URL, active-listing and independent second-pass controls.
// No general parts/accessory-category relaxation is introduced.
