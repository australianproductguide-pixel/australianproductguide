...
// APG eBay product-image exact identity guard v3.29.
// Adds four tightly item-bound residual recoveries after live eBay detail plus independent product
// evidence proved the maintained identity: De'Longhi Rivelia EXAM440.55.B, CATLINK Scooper Luxury
// Pro-X, Marshall Monitor III A.N.C. and ESR Qi2 3-in-1 Travel Wireless Charging Set. Each rule is
// exact-item and title-bound, with structured evidence where available. No global model, category,
// accessory, sibling, voltage, condition, price, active-listing or marketplace control is relaxed.
