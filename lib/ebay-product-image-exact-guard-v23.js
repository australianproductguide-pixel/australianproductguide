...
// APG eBay product-image exact identity guard v3.1.
// Extends v3.0 for an evidence-backed direct eBay AU item whose exact whole-product title is
// independently verified but whose Browse detail omits a structured model field. The named-identity
// fallback is permitted only for the registered APG slug + exact Browse item ID + direct retrieval,
// while retaining category, title, sibling, bundle, voltage, condition, URL, AUD-price and active-
// listing controls. Recommendation weight remains zero.
