...
// APG eBay product-image exact identity guard v3.26.
// Extends v3.25 with one item-bound Nebula Capsule 3 D2425 recovery. The APG product is canonically
// branded Anker while eBay structures this exact projector under Anker's NEBULA sub-brand, so the
// exception requires the exact current item plus structured D2425 evidence and exact title identity.
// The plain Capsule 3 is also explicitly protected from Capsule 3 Laser / D2426 sibling evidence.
// All prior accessory, sibling, bundle, category, condition, price and active-listing controls remain.
