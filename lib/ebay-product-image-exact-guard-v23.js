...
// APG eBay product-image exact identity guard v3.16.
// Extends v3.15 with a narrowly item-bound title-proof path for the current Kindle Paperwhite
// Signature Edition 32GB listing. The current Australian listing is sold as Brand KINDLE rather
// than Amazon, so identity is proven only for this exact item and only when the title states
// Paperwhite, 12th Gen, 7-inch, Signature Edition and 32GB. It does not create a general brand alias.
// UGREEN Revodok 107 remains protected by its exact item + structured SKU 60515 rule. Generic
// accessory, sibling, bundle, category, condition, voltage, AUD-price, eBay-image-host, eBay AU URL
// and active-listing controls remain fail-closed, including the v3.13 mount-accessory protection.
