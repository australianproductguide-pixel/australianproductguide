...
// APG eBay product-image exact identity guard v3.19.
// Extends v3.18 with two item-bound Insta360 recoveries. The current X4 and X5 eBay AU listings
// publish structured model/MPN identifiers that independently match Australian retailer records:
// X4 INS-INSTAONEX4 / 6970357855506 and X5 INS-INSTAONEX5 / 6977644761441. Each rule remains bound
// to one exact item plus the full Insta360 camera title, so short X4/X5 names do not create a broad
// title-only fallback. Revodok 1071, Paperwhite Signature Edition and prior rules remain unchanged.
