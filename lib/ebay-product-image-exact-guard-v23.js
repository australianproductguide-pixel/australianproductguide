...
// APG eBay product-image exact identity guard v3.15.
// Extends v3.14 with a narrowly item-bound title-proof path for products where eBay supplies no
// structured model field but the current listing itself names the maintained model unambiguously.
// The first title-only rule covers one exact Amazon Kindle 2024 item whose live eBay detail says
// Amazon Kindle 2024, 6-inch e-reader and 16GB. It does not create a general Amazon/Kindle alias.
