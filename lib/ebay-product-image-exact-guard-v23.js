...
// APG eBay product-image exact identity guard v2.9.
// Extends the conservative v2.8 guard for APG USB-C hub/dock products whose legitimate whole
// products can sit in eBay's "USB Cables, Hubs & Adapters" leaf. The override is explicit by APG
// category and a tightly bounded terminal leaf, then the complete base exact-product guard is
// re-run. Parts/accessories/components/replacements/spares remain rejected. Title/model/sibling/
// bundle/pack/voltage/condition/URL/AUD-price/state checks remain unchanged and recommendation
// weight remains zero.
