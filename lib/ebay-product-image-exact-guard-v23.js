...
// APG eBay product-image exact identity guard v3.9.
// Extends v3.8 with one evidence-bound retail-bundle exception for Oral-B Pro 2500X.
// Oral-B Australia defines the Pro 2500X retail product as including a travel case and charger;
// therefore that exact registered eBay item is not treated as an unrelated accessory bundle.
// All model, sibling, accessory/category, condition, voltage, AUD-price, URL, active-listing and
// independent second-pass controls remain fail-closed.
...
const EVIDENCE_BOUND_WHOLE_PRODUCT_LEAVES=Object.freeze({
  ...
  'amazon-echo-show-5-3rd-gen':Object.freeze({category:'smart-displays',itemIds:['v1|147441885504|0','v1|156290332911|457319993320','v1|377348724970|0','v1|398238099579|0','v1|398343958386|0','v1|407078982439|0'],leaves:[/.+/i],identityPhrases:['amazon','echo show 5','3rd gen']}),
