...
// APG eBay product-image exact identity guard v2.6.
// Extends the conservative v2.5 named-product fallback for legitimate branded retail identities
...
// v2.6 adds explicit unexpected-bundle component detection so an exact core product bundled with a
// solar panel, memory card, case or extra battery cannot be presented as the maintained standalone
// product unless that component is part of APG's maintained identity.
...
module.exports={VERSION,MODEL_GATE_FAILURES,GENERIC_NAME_WORDS,EXTRA_ACCESSORY_TITLE_PATTERNS,BUNDLE_COMPONENT_RULES,phraseInTitle,extraAccessoryTitle,unexpectedBundleComponent,brandlessName,meaningfulModelTokens,nameCoreWords,nameCore,namedIdentityCheck,evaluate};
