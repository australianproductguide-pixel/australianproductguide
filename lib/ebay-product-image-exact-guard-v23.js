...
// APG eBay product-image exact identity guard v3.6.
// Extends v3.5 with a small evidence-bound residual set where current eBay AU candidates passed
// detailed product verification and failed only because eBay classified the whole product under an
// accessory-like category. Each exception is restricted to the maintained APG slug, exact current
// Browse item IDs and product-specific title identity. Unregistered items remain fail-closed and all
// model, sibling, bundle, voltage, condition, AUD-price, URL, active-listing and independent
// second-pass controls still run. Recommendation weight remains zero.
