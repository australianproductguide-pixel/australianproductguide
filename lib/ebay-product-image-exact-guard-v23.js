...
// APG eBay product-image exact identity guard v3.23.
// Extends v3.22 with one item-bound Miofive S1 recovery. The current Brand New eBay AU item exposes
// structured model S1 (4K), 2160p, 3-inch display, Miofive brand and a complete S1 dash-cam kit. eBay
// places the whole dash camera under a Vehicle Parts & Accessories parent, so this exact item is allowed
// through the existing evidence-bound category override. Apple AirTag 4 Pack, PETLIBRO, Revodok Pro 106,
// ZeroWater, Revodok 1071, Insta360 X4/X5, Paperwhite and prior rules are unchanged. Generic accessory,
// sibling, bundle, category, condition, voltage, AUD-price, eBay-image-host, eBay AU URL and active-listing
// controls remain fail-closed, including the v3.13 mount protection.
