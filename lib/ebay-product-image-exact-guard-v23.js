...
// APG eBay product-image exact identity guard v3.22.
// Extends v3.21 with one item-bound Apple AirTag 4 Pack recovery. The current eBay AU item is Brand New,
// explicitly names Apple AirTag and 4 Pack, publishes an Australian-origin tracker listing and is image-hosted
// by eBay. eBay categorises the whole product under Other Mobile Accessories, so this exact item is allowed
// through the existing evidence-bound whole-product category override. The separate 4-pack guard remains
// active, and no broad AirTag/category/model relaxation is introduced. PETLIBRO, Revodok Pro 106, ZeroWater,
// Revodok 1071, Insta360 X4/X5, Paperwhite and prior rules are unchanged. Generic accessory, sibling, bundle,
// category, condition, voltage, AUD-price, eBay-image-host, eBay AU URL and active-listing controls remain
// fail-closed, including the v3.13 mount protection.
