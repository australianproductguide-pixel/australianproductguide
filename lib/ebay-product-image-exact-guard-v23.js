...
// APG eBay product-image exact identity guard v3.10.
// Extends v3.9 with the independently verified current Amazon Echo Show 5 (3rd Gen) recovery item.
// The item remains title-bound, product-bound and subject to the base v2.7 manufacturer-model alias;
// this addition only permits its exact current item ID through the evidence-bound whole-product
// category path already used for verified Echo Show 5 listings. All model, sibling, accessory/category,
// condition, voltage, AUD-price, URL, active-listing and independent second-pass controls remain fail-closed.
...
const EVIDENCE_BOUND_CANONICAL_LEAVES=Object.freeze({
  'power-banks':'Power Banks','tyre-inflators':'Tyre Inflators','gaming-controllers':'Controllers','dash-cameras':'Dash Cams','smart-displays':'Smart Displays','portable-fridges':'Portable Fridges','televisions':'Televisions','smart-scales':'Bathroom Scales','bluetooth-trackers':'Smart Trackers'
});
