...
// APG eBay product-image exact identity guard v3.8.
// Extends v3.7 with one evidence-bound direct-item sibling exception for Withings Body Comp.
// The exception applies only to the registered current Browse item when the title independently
// proves Withings + Body Comp + WBS12. All accessory/category, condition, voltage, AUD-price,
// URL, active-listing and independent second-pass controls remain fail-closed.
