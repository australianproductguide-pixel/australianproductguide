...
// APG eBay product-image exact identity guard v3.17.
// Extends v3.16 by moving Paperwhite Signature Edition recovery to the cleaner current Metallic
// Black listing. That exact eBay AU item must publish manufacturer model B0CFPHTMDX and its title
// must state Kindle Paperwhite, 12th Gen, 7-inch, Signature Edition and 32GB. eBay still labels the
// brand KINDLE rather than Amazon, but no general Kindle/Amazon alias is created. UGREEN Revodok 107
// remains protected by exact item + structured SKU 60515. Generic accessory, sibling, bundle,
// category, condition, voltage, AUD-price, eBay-image-host, eBay AU URL and active-listing controls
// remain fail-closed, including the v3.13 mount-accessory protection.
