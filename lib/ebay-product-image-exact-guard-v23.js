...
// APG eBay product-image exact identity guard v3.27.
// Extends v3.26 with one exact item-bound Nintendo Switch Pro Controller whole-product recovery from
// eBay's mixed "Controllers & Attachments" category. The exception requires the exact current item,
// exact Nintendo Switch Pro Controller title identity and this specific category leaf; it does not
// broaden controller-category acceptance generally. All prior accessory, sibling, bundle, category,
// condition, price, model/variant, active-listing and AU marketplace controls remain fail-closed.
