...
// APG eBay product-image exact identity guard v3.13.
// Extends v3.12 by rejecting clear accessory-only wall/shelf/desk/ceiling mounts and mounting
// brackets/plates before named-product fallback can promote them. This closes a false-positive path
// observed on eero Max 7 and Eufy monitor mount listings without treating the word "mount" alone as
// accessory evidence. All item, model, sibling, bundle, category, condition, voltage, AUD-price,
// image-host, URL and active-listing controls remain fail-closed.
