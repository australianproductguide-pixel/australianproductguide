...
// APG eBay product-image exact identity guard v3.20.
// Extends v3.19 with two evidence-bound recoveries. UGREEN Revodok Pro 106 is bound to one exact
// eBay AU item whose live title/specification set matches UGREEN's official 6-in-1, 10Gbps,
// 4K@60Hz product and whose eBay GTIN 06941876243631 matches UGREEN's official product page.
// ZeroWater 12-Cup Ready-Pour is bound to exact item/model ZD-012RP, corroborated by ZeroWater's
// official product records. Revodok 1071, Insta360 X4/X5, Paperwhite and prior rules are unchanged.
// Generic accessory, sibling, bundle, category, condition, voltage, AUD-price, eBay-image-host,
// eBay AU URL and active-listing controls remain fail-closed, including the v3.13 mount protection.
