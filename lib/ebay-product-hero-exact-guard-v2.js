...
// APG eBay product hero exact-identity guard v2.4.
...
// v2.4 strips Unicode combining marks after NFKD normalisation so equivalent brand/model spellings
// such as Kärcher/Karcher reconcile without weakening any identity gate.
...
// products. Keep these product-scoped rather than adding ambiguous terms such as "DC" to the
// global model-suffix list: ordinary listings may legitimately mention DC inputs/outputs.
// A strong manufacturer SKU can explicitly override an exclusion when it proves the maintained
// variant. Conservative false negatives are preferable to a wrong product photograph.
...
module.exports={
  VERSION,ACCESSORY_TITLE_PATTERNS,ACCESSORY_CATEGORY_PATTERNS,PRODUCT_VARIANT_EXCLUSIONS,clean,norm,compact,productIdentity,evidenceModels,evidenceText,
  titleLooksAccessory,categoryLooksAccessory,compatibilityTargetConflict,packCounts,packOrBundleConflict,isSpecificModel,
  modelEvidenceCompatible,titleModelCandidates,titleIdentityCoverage,titleSpecificModelCheck,modelEvidenceCheck,siblingModelConflict,productVariantConflict,
