...
// APG eBay product hero exact-identity guard v2.7.
...
// v2.7 extends the evidence-bound alias path to products whose APG model token is generational/generic,
// and adds the independently verified Amazon Echo Show 5 (3rd Gen) manufacturer model B09B2RL8CG.
...
const ACCESSORY_TITLE_PATTERNS=[
  ...
  /\bconversion\s+(?:chart\s+)?plate\b/i,
