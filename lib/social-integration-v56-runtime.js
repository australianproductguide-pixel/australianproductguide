...
const icons={
  instagram:'<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="12" cy="12" r="4" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="17.4" cy="6.8" r="1.1"/></svg>',
  threads:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2.8c-5.3 0-9 3.7-9 9.1 0 5.3 3.7 9.3 9.2 9.3 4.5 0 7.8-2.5 8.4-6.1.6-3.6-1.5-6.2-5.1-6.8-2.4-.4-4.5.4-5.8 2.1-1.5 2-.8 4.8 1.3 5.7 2.4 1 5.4-.4 5.9-3 .6-3.4-1.4-6.4-4.4-7.2-2.4-.6-4.8.1-6.4 1.8" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"/></svg>',
  ...
  pinterest:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12.2 2.5c-5.2 0-8.7 3.7-8.7 8.2 0 3.2 1.8 5.7 4.4 6.7-.1-.6-.1-1.5 0-2.2l1.1-4.7s-.3-.7-.3-1.8c0-1.7 1-3 2.2-3 1 0 1.6.8 1.6 1.8 0 1.1-.7 2.7-1 4.1-.3 1.2.6 2.2 1.8 2.2 2.1 0 3.7-2.2 3.7-5.4 0-2.8-2-4.8-4.9-4.8-3.3 0-5.3 2.5-5.3 5.1 0 1 .4 2.1.9 2.7.1.1.1.2.1.4l-.3 1.2c-.1.4-.4.5-.8.3-1.6-.7-2.6-2.9-2.6-4.7 0-3.8 2.8-7.3 8-7.3 4.2 0 7.4 3 7.4 7 0 4.2-2.6 7.5-6.3 7.5-1.2 0-2.4-.6-2.8-1.4l-.8 2.9c-.3 1.1-1 2.4-1.5 3.2 1.1.3 2.3.5 3.6.5 5.2 0 8.8-3.8 8.8-8.7 0-4.7-4-8.6-8.8-8.6Z"/></svg>',
  ...
  facebook:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M13.7 21v-8h2.7l.4-3h-3.1V8.1c0-.9.3-1.5 1.6-1.5H17V4a22 22 0 0 0-2.4-.1c-2.4 0-4.1 1.5-4.1 4.2V10H7.8v3h2.7v8h3.2Z"/></svg>'
};
...
function linkHtml(item,compact=false){
  ...
  return `<a class="${compact?'apg-mobile-social-v56-link':'apg-social-v56-link'}" href="${esc(item.url)}" target="_blank" rel="me noopener noreferrer" aria-label="${esc(label)}"><span class="${glyphClass(item.key)}" aria-hidden="true">${icons[item.key]||esc(item.platform.slice(0,2))}</span><span>${esc(item.platform)}</span></a>`;
}
