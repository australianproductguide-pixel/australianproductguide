...
function inject(html,path){
  ...
  // eBay Smart Placement v1.6 owns the /deals/ category-creative presentation. Do not layer the
  // older v121 gallery underneath it: v1.6 deliberately removed the incomplete Certified
  // Refurbished tile and customer-facing implementation label from that route. Home and genuinely
  // matched category/guide discovery remain governed by v121 until their separate replacement is
  // certified. This is presentation ownership only; affiliate/recommendation weighting is unchanged.
  ...
  // Home: keep official eBay creative inside the existing governed eBay discovery area so paid
  // retailer imagery is clearly separated from APG editorial recommendations.
  if(path==='/'){
