...
// APG eBay Australia category shopping presentation v133.2.
// Historical filename retained for integration compatibility. Each shopper-facing category tile
// is explicitly mapped by category key to its matching first-party eBay Partner Network Creative
// Gallery preview asset. This removes the prior local-file corruption/mismatch risk while keeping
// the cleaner v133 card/carousel structure and disclosure treatment. These retailer promotional
// assets are not APG product evidence or recommendation inputs.
