...
body[data-apg-premium-v107="true"] .scout-v5-card-actions button{min-height:40px}
...
body[data-apg-premium-v107="true"] .scout-v107-context-label{flex:0 0 100%;color:#64748b;font-size:9.5px;font-weight:900;letter-spacing:.08em;text-transform:uppercase;margin-top:3px}
...
@media(max-width:760px){
  ...
  body[data-apg-premium-v107="true"] h1{font-size:clamp(36px,11.5vw,50px);line-height:1.03}
  body[data-apg-premium-v107="true"] h2{font-size:clamp(27px,8vw,36px);line-height:1.1}
  ...
  body[data-apg-premium-v107="true"] .global-search{grid-template-columns:auto minmax(0,1fr) auto}
  body[data-apg-premium-v107="true"] .global-search input{padding-block:12px!important}
  ...
  body[data-apg-premium-v107="true"] :where(.feature-card,.comparison-card,.brand-card,.soft-panel,.decision-card,.winner-card,.retailer-panel,.evidence-box){padding:20px}
  ...
  body[data-apg-premium-v107="true"] .compare-wrap{margin-top:18px}
  body[data-apg-premium-v107="true"] .compare tr{margin-bottom:16px;border:1px solid #dbe5ef;border-radius:16px;box-shadow:0 4px 14px rgba(15,47,74,.04)}
  body[data-apg-premium-v107="true"] .compare td{padding:15px 16px!important;line-height:1.5}
  ...
  body[data-apg-premium-v107="true"] .compare td[data-apg-compare-label]:not(:first-child)::before{content:attr(data-apg-compare-label);display:block;margin-bottom:5px;color:#1d4ed8;font-size:10px;font-weight:900;letter-spacing:.07em;text-transform:uppercase}
  body[data-apg-premium-v107="true"] .compare-tray{left:var(--apg-premium-gutter);right:var(--apg-premium-gutter);transform:none;width:auto;bottom:max(10px,env(safe-area-inset-bottom));border-radius:16px;padding:11px 12px}
...
@media(max-width:380px){
  ...
  body[data-apg-premium-v107="true"] .category-card{grid-template-columns:54px minmax(0,1fr);padding:18px 16px}
...
function contextualPrompts(){const host=qs('.scout-v5-suggestions');if(!host||qs('.scout-v107-context-suggestions'))return;const type=routeContext(),items={product:[['Bad fit?','What would make this product a bad fit for me?'],['Evidence gaps','What evidence is uncertain for this product?'],['Closest alternative','What is the closest maintained alternative?']],comparison:[['Decision differences','What actually changes the decision here?'],['Neither option?','When is neither option the right choice?'],['Apply my budget','Apply my budget and priorities to this comparison']],category:[['What matters','What matters most in this category?'],['Deal-breakers','What deal-breakers should I think about?'],['Build a shortlist','Help me build a shortlist for my situation']],finder:[['What matters','What matters most in this category?'],['Check my brief','Help me tighten my buying brief'],['Explain result','Explain why this result fits me']],guide:[['Key decisions','What are the key decisions in this guide?'],['Help me choose','Turn this guide into a shortlist for me'],['Evidence gaps','What should I verify before buying?']],search:[['Better search','Help me improve my search'],['Turn into brief','Turn this search into a buying brief'],['Which tool next?','Should I use Search, Compare or Decision Lab next?']], 'decision-lab':[['Why this won','Why did this option win?'],['What changes it','What would change this recommendation?'],['Confidence','What is uncertain or unverified here?']], 'my-apg':[['Saved options','What have I saved?'],['Compare saved','Help me compare my saved options'],['Next step','What should I do next with my shortlist?']],home:[['How APG connects','How do Search, Scout, Decision Lab and Compare work together?'],['Start my decision','Help me choose a product for my situation'],['What can Scout do?','What can you help me with on this site?']],other:[['Guide this page','Help me with this page'],['Find the right tool','What APG tool should I use?'],['Start a decision','Help me choose a product']]}[type]||[];if(!items.length)return;const wrap=document.createElement('div');wrap.className='scout-v107-context-suggestions';wrap.innerHTML='<span class="scout-v107-context-label">Useful next questions</span>'+items.map(item=>'<button type="button" class="scout-v5-chip" data-scout-v5-ask="'+item[1].replace(/&/g,'&amp;').replace(/"/g,'&quot;').replace(/</g,'&lt;')+'">'+item[0]+'</button>').join('');host.insertAdjacentElement('afterend',wrap)}
