...
/* A 90-category directory needs scanability: one short summary and one primary action per tile. */
body[data-apg-category-index-images="v61"] .category-grid .category-card>div>p:not(.eyebrow){font-size:13.5px!important;line-height:1.45!important;margin-top:4px!important;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden}
body[data-apg-category-index-images="v61"] .category-grid .category-card .pills{display:none!important}
body[data-apg-category-index-images="v61"] .category-grid .category-card .card-actions{padding-top:10px!important;gap:0!important}
body[data-apg-category-index-images="v61"] .category-grid .category-card .card-actions .text-link{display:none!important}
body[data-apg-category-index-images="v61"] .category-grid .category-card .card-actions .button.secondary{min-height:0!important;padding:8px 11px!important;font-size:12.5px!important}
