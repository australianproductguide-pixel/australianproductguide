...
const CATEGORY_INDEX_IMAGES_VERSION='61.4';
...
function enrichCategoryCard(card){
  ...
  // Replace it with the governed category image. v61.4 deliberately treats the
...
/* v61.4: professional retail-directory hierarchy for the 90-category hub. */
