...
body[data-scout-v5="true"] .scout-v5-kicker{display:block;margin-bottom:5px;color:#1d4ed8;font-size:10px;font-weight:900;letter-spacing:.08em;text-transform:uppercase}
...
body[data-scout-v5="true"] .scout-v5-chip{border:1px solid #cbd5e1;background:#fff;color:#0f172a;border-radius:999px;padding:8px 10px;font:inherit;font-size:11.5px;font-weight:800;cursor:pointer;text-align:left}
...
body[data-scout-v5="true"] .scout-v5-card{border:1px solid #e2e8f0;border-radius:16px;background:#fff;padding:12px;box-shadow:0 5px 17px rgba(15,23,42,.045)}
...
body[data-scout-v5="true"] .scout-v5-card-watch{margin:7px 0 0;padding:7px 8px;border-radius:10px;background:#f1f5f9;color:#475569;font-size:10.5px;line-height:1.4}
body[data-scout-v5="true"] .scout-v5-card-actions{display:flex;flex-wrap:wrap;gap:6px;margin-top:10px}
body[data-scout-v5="true"] .scout-v5-card-actions a,body[data-scout-v5="true"] .scout-v5-card-actions button{display:inline-flex;align-items:center;justify-content:center;border:1px solid #cbd5e1;background:#fff;color:#1d4ed8;border-radius:10px;padding:7px 9px;font:inherit;font-size:10.5px;font-weight:850;text-decoration:none;cursor:pointer}
body[data-scout-v5="true"] .scout-v5-actions{display:flex;flex-wrap:wrap;gap:7px;margin:0 0 2px 33px}
body[data-scout-v5="true"] .scout-v5-action{display:inline-flex;align-items:center;justify-content:center;border:1px solid #cbd5e1;background:#fff;color:#1d4ed8;border-radius:11px;padding:8px 10px;font:inherit;font-size:11px;font-weight:850;text-decoration:none;cursor:pointer}
body[data-scout-v5="true"] .scout-v5-action.primary{background:#2563eb;border-color:#2563eb;color:#fff}
body[data-scout-v5="true"] .scout-v5-feedback{display:flex;gap:6px;margin:-3px 0 2px 33px;align-items:center;color:#64748b;font-size:10px}
body[data-scout-v5="true"] .scout-v5-feedback button{border:0;background:transparent;color:#475569;font:inherit;font-size:10px;text-decoration:underline;cursor:pointer;padding:3px}
...
body[data-scout-v5="true"] .scout-v5-dot{width:7px;height:7px;border-radius:50%;background:#06b6d4;animation:scoutV5Pulse 1s infinite alternate}
@keyframes scoutV5Pulse{to{opacity:.25;transform:scale(.82)}}
body[data-scout-v5="true"] .scout-v5-composer{border-top:1px solid #e2e8f0;background:#fff;padding:10px 12px 11px}
...
body[data-scout-v5="true"] .scout-v5-helper{margin:6px 2px 0;color:#64748b;font-size:9.5px;line-height:1.35}
...
function thread(){let t=body.querySelector('.scout-v5-thread');if(!t){body.innerHTML='<div class="scout-v5-thread scout-thread"></div>';t=body.firstElementChild;}return t;}
...
async function bootstrap(){
 if(state.ready)return;body.innerHTML='<div class="scout-v5-thread scout-thread"><div class="scout-v5-status" role="status"><span class="scout-v5-dot"></span><span>Opening Scout…</span></div></div>';
