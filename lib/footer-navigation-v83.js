...
// APG Footer Navigation v83.2.
// The footer destinations use canonical native links. This outer interaction layer
// keeps reliable physical hit targets, restores the compact two-column phone layout,
// aligns mobile link text exactly with its group heading, gives Cookie preferences a
// quieter utility treatment, and temporarily clears Scout from the footer interaction
// area while the footer is visible. It does not intercept clicks or replace native
// browser navigation.
const downstream=require('./trust-centre-authoritative-v82');

const FOOTER_NAVIGATION_VERSION='83.2';
