...
// v47 uses the same current APG blue/navy presentation contract as Brand System v46.
// Green remains semantic-success only and the homepage maintained-research strip is
// the sole approved yellow/gold heritage surface.
const CSS=`
...
[data-consumer-intelligence-v47=true] .ci47-actions a{display:inline-flex;align-items:center;justify-content:center;min-height:42px;padding:9px 14px;border-radius:12px;border:1px solid #2563EB;text-decoration:none;font-weight:700}
[data-consumer-intelligence-v47=true] .ci47-actions a:first-child{background:#2563EB;color:#FFFFFF}
[data-consumer-intelligence-v47=true] .ci47-actions a:not(:first-child){background:#FFFFFF;color:#1D4ED8;border-color:#BFDBFE}
[data-consumer-intelligence-v47=true] .ci47-actions a:hover{background:#DBEAFE;color:#0F172A;border-color:#93C5FD}
