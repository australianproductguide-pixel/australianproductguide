...
function transform(html,path,u){
  ...
  out=upgradeProductArticles(out,path,u);
...
module.exports={VERSION,HEADER,articleClasses,productSlug,shouldUpgradeArticle,productCardV1121,upgradeProductArticles,preserveExactRetailerVisualContract,transform,wrap};
